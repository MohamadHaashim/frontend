...
const productEditAPI = API_EP_BOOK.PRODUCT_EDIT_API_EP;
...
const VendorAPI = {
    ...
    productEditAPI: function (apiData: any) {
        const requestAPIData = {
            bodyData: apiData
        }; const getResponse = API(productEditAPI, requestAPIData);
        return getResponse;
    },
    productGetAPI: function (id:any) {
        ...
        const getResponse = API(requestAPIData);
        return getResponse;
    },
