...
class ForgorpasswordSuccess extends Component<{}, FormState> {
        ...
        <div className="contanier-type1">
          <form onSubmit={this.handleSubmit}>
            <div className="mb-3">
              ...
              <h3>Check your email to reset the password</h3>
              <p>
                Reset password link sent <span className="underline">{userEmail}</span>. Please click the link to continue.
              </p>
