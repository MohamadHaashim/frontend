...
function AdGroupTable(props) {
  ...
  const handleExportData = async () => {
    setSpinner(true);
    if(props.selectedProfiles === "SP"){
      exporturl ="https://adsexpert-api.getgrowth.agency/Ads/SPCampaignManager/AdGroups/Export"
    }
    else if(props.selectedProfiles === "SB"){
      exporturl ="https://adsexpert-api.getgrowth.agency/Ads/SBCampaignManager/AdGroups/Export"
    }
    else if(props.selectedProfiles === "SD"){
      exporturl ="https://adsexpert-api.getgrowth.agency/Ads/SDCampaignManager/AdGroups/Export"
    }
    try {
      let advancedFilters: any = [];
      let advancedFilterDateRange: any = {};
