...
function CampaignTable(props) {
  ...
  const handleExportData = async () => {
    ...
    if (props.selectedProfiles === "SP") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SPCampaignManager/Campaigns/Export";
    } else if (props.selectedProfiles === "SB") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SBCampaignManager/Campaigns/Export";
    } else if (props.selectedProfiles === "SD") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SDCampaignManager/Campaigns/Export";
    }
    try {
      let advancedFilters: any = [];
      let advancedFilterDateRange: any = {};
