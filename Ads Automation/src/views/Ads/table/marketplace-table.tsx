...
function MarketplaceTable(props) {
  ...
  useEffect(() => {
    console.log(props.filterDateRange);
  ...
  const fetchData = async () => {
    ...
    if (props.selectedProfiles === "SP") {
      ...
      apiEndPoint =
        "https://adsexpert-api.getgrowth.agency/Ads/SBCampaignManager/" +
        props.tabName;
    }
     else if (props.selectedProfiles === "SD") {
      apiEndPoint =
        "https://adsexpert-api.getgrowth.agency/Ads/SDCampaignManager/" +
        props.tabName;
    }
  ...
  const handleExportData = async () => {
    ...
    if (props.selectedProfiles === "SP") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SPCampaignManager/MarketPlaces/Export";
    } else if (props.selectedProfiles === "SB") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SBCampaignManager/MarketPlaces/Export";
    }
     else if (props.selectedProfiles === "SD") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SDCampaignManager/MarketPlaces/Export";
    }
    try {
