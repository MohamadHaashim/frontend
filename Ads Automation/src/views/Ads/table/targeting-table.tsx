...
function TargetingTable(props) {
  ...
  const handleExportData = async () => {
    ...
    if (props.selectedProfiles === "SP") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SPCampaignManager/Targets/Export";
    } else if (props.selectedProfiles === "SB") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SBCampaignManager/Targets/Export";
    } else if (props.selectedProfiles === "SD") {
      exporturl =
        "https://adsexpert-api.getgrowth.agency/Ads/SDCampaignManager/Targets/Export";
    }
    try {
      let advancedFilters: any = [];
      let advancedFilterDateRange: any = {};
