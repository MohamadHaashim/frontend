...
const AddNewRules: React.FC<ResultProps> = (props) => {
  ...
  const submitAddRule = async () => {
    ...
    let url = "https://adsexpert-api.getgrowth.agency/Rule";
    const action = {
      data: actionCriteria,
    };
    const ifdata = {
  ...
  const templateCall = async () => {
    if (templateId !== "") {
      ...
      let AuthToken = "Bearer " + userToken;
      let url =
        "https://adsexpert-api.getgrowth.agency/Rule/Template/" +
        templateId;
      const requestOptions = {
        method: "GET",
        headers: {
  ...
  const getRule = async () => {
    ...
    let AuthToken = "Bearer " + userToken;
    let url =
      "https://adsexpert-api.getgrowth.agency/Rule/" + id;
    const requestOptions = {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  const getRulesMetaData = async () => {
    ...
    let AuthToken = "Bearer " + userToken;
    let url =
      "https://adsexpert-api.getgrowth.agency/MasterData/Rules_Creation";
    const response = await fetch(url, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
