...
function Revenue(props) {
  ...
  const revenue = async () => {
    ...
    let url =
      "https://adsexpert-api.getgrowth.agency/SellingPartnerService/Sales/Revenue";
  ...
  const handleExportData = async () => {
    ...
    let AuthToken = "Bearer " + userToken;
    let url2 =
      "https://adsexpert-api.getgrowth.agency/SellingPartnerService/Sales/Revenue/Export";
