...
function BuyBox(props) {
  ...
  const buyBox = async () => {
    ...
    let url =
      "https://adsexpert-api.getgrowth.agency/SellingPartnerService/Sales/BuyBox";
  ...
  const handleExportData = async () => {
    ...
    let AuthToken = "Bearer " + userToken;
    let url2 =
      "https://adsexpert-api.getgrowth.agency/SellingPartnerService/Sales/BuyBox/Export";
