...
function TemplateListTable(props) {
  let apiEndPoint = "https://adsexpert-api.getgrowth.agency/Rule/Templates/All";
  ...
  const Duplicaate = async (id, profileId) => {
    ...
    let AuthToken = "Bearer " + userToken;
    const response = await fetch(
      "https://adsexpert-api.getgrowth.agency/Rule/Template/Duplicate/" + id,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
                ...
                <>
                  <div className="col-action-container text-right">
                    ...
                    >
                      ...
                      <li>
                        <Link
                          to={"/ads/add-automation-newrules/" + params.row.id +"/templateUpdate"}
                        >
                          <p className="dropdown-item">Edit</p>
                        </Link>
                      </li>
