...
const PaginationComponent = ({ itemPerPage, totalItems, paginate, currentPage }) => {
  console.log("pagination",Math.ceil(totalItems / itemPerPage),  currentPage )
  const pageNumbers = [];
  ...
  const paginationNumber = () => {
    if(pageNumbers.length <= 5){
      if(pageNumbers.length < 5 && currentPage < Math.ceil(totalItems / itemPerPage) && currentPage != Math.ceil(totalItems / itemPerPage) ){
        console.log("paginationNumber",currentPage,currentPage+1,Math.ceil(totalItems / itemPerPage))
        return [currentPage,currentPage+1];
      }else if(pageNumbers.length <= 5 && currentPage == Math.ceil(totalItems / itemPerPage)) {
