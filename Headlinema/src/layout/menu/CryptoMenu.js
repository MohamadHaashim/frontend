...
const MenuItem = ({ icon, link, text, sub, subPanel, panel, sidebarToggle, newTab, badge, mobileView, ...props }) => {
  let currentUrl;
...
const CryptoMenu = ({ sidebarToggle, mobileView }) => {
