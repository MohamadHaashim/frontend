const menu = [
  ...
  // {
  //   icon: "puzzle",
  //   text: "Listing optimizers",
  //   link: "/optimizers",
  // },
  // {
  //   icon: "text",
  //   text: "Products translator",
  //   link: "/products-translator",
  // },
  // {
  //   icon: "img-fill",
  //   text: "Image optimizers",
  //   link: "/img-optimizers",
  // },
  // {
  //   icon: "list-thumb",
  ...
  //   link: "/market-feedback",
  // },
  // {
  //   icon: "growth",
  //   text: "Profitability tool",
  //   link: "/analytics",
  // },
  // {
  //   icon: "msg",
  ...
  //   icon: "focus",
  //   text: "APIs Tester",
  //   link: "/amazon-api/tester",
  // },
  // {
  //   icon: "row-mix",
  //   text: "Data sync",
  //   link: "/amazon-api/data-sync",
  // },
