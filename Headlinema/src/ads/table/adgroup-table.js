...
function AdGroupTable(props) {
  ...
  const fetchData = async () => {
    ...
    if(props.selectedProfiles === "SP"){
      apiEndPoint= "https://api.agilensmart.com/Ads/SPCampaignManager/" +  props.tabName;
     }
     else if(props.selectedProfiles === "SB"){
       apiEndPoint= "https://api.agilensmart.com/Ads/SBCampaignManager/" +  props.tabName;
     }
     else if(props.selectedProfiles === "SD"){
       apiEndPoint= "https://api.agilensmart.com/Ads/SDCampaignManager/" +  props.tabName;
     }
  ...
  const handleExportData = async () => {
    setSpinner(true);
    if(props.selectedProfiles === "SP"){
      exporturl ="https://api.agilensmart.com/Ads/SPCampaignManager/AdGroups/Export"
    }
    else if(props.selectedProfiles === "SB"){
      exporturl ="https://api.agilensmart.com/Ads/SBCampaignManager/AdGroups/Export"
    }
    else if(props.selectedProfiles === "SD"){
      exporturl ="https://api.agilensmart.com/Ads/SDCampaignManager/AdGroups/Export"
    }
    try {
      let advancedFilters = [];
      let advancedFilterDateRange = {};
