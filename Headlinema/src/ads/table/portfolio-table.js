...
function PortfoliosTable(props) {
  ...
  const handleExportData = async () => {
    ...
    if(props.selectedProfiles === "SP"){
      exporturl ="https://api.agilensmart.com/Ads/SPCampaignManager/Portfolios/Export"
    }
    else if(props.selectedProfiles === "SB"){
      exporturl ="https://api.agilensmart.com/Ads/SBCampaignManager/Portfolios/Export"
    }
    else if(props.selectedProfiles === "SD"){
      exporturl ="https://api.agilensmart.com/Ads/SDCampaignManager/Portfolios/Export"
    }
