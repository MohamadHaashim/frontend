    ...
    <View style={styles.container}>
      ...
      > */}
        ...
        <View style={styles.inputContainer}>
          ...
          {isEditing ? (
            ...
            <Text style={[isTablet ? styles.tabletinput : styles.input, { fontWeight: 'bold' }]} numberOfLines={1}>{userData.name || "N/A"}</Text>
          )}
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          {isEditing ? (
            ...
            <Text style={[isTablet ? styles.tabletinput : styles.input, { fontWeight: 'bold' }]} numberOfLines={1}>{userData.surname || "N/A"}</Text>
          )}
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          {isEditing ? (
            ...
            <Text style={[isTablet ? styles.tabletinput : styles.input, { fontWeight: 'bold' }]} numberOfLines={1}>{userData.gender || "N/A"}</Text>
          )}
        </View>
        ...
        <View style={styles.inputContainer}>
          ...
          {isEditing ? (
            ...
            <Text style={[isTablet ? styles.tabletinput : styles.input, { fontWeight: 'bold' }]} numberOfLines={1}>{userData.email || "N/A"}</Text>
          )}
        </View>
      ...
      <View style={styles.registerContainer}>
        <TouchableOpacity onPress={isEditing ? handleUpdate : handleEditToggle} activeOpacity={0.8}>
          ...
          >
            <Text style={isTablet ? styles.tabletsubmitbutton : styles.submitbutton}>{isEditing ? 'Save Changes' : 'Edit Profile'}</Text>
          </LinearGradient>
        </TouchableOpacity>
