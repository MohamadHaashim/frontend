...
export default function Register() {
  ...
  const resetFields = () => {
    [setname, setsurname, setNumber, setemail, setpassword, setconpassword, setChecked].forEach(setState => setState(''));
    setErrors({
      name: '',
      surname: '',
      email: '',
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log("----------  handlgfgfghfgfe register -------")
      setname("");
      setsurname("");
      setgender("");
      setNumber("");
      ...
      const errorMessages = data.details || data.messages || [];
      const firstError =
      ...
      if (Array.isArray(errorMessages)) {
        errorMessages.forEach((msg) => {
          ...
          if (lower.includes("email")) {
            ...
            apiErrors.number = msg;
          } else {
            apiErrors.register = msg;
          }
 ...
 const handleverfication = async () => {
  ...
  if (!valid) return { success: false, message: "Validation failed" };
    ...
    try {
      ...
      console.error("handleverfication error:", error);
  ...
  const formatRomanianPhoneNumber = (rawNumber, callingCode) => {
    let digitsOnly = rawNumber.replace(/[^0-9]/g, '');
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#000000" }}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.overlay}>
              <View style={styles.inputWrapper}>
                ...
                {errors.name && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.name}</Text>}
              </View>
              <View style={styles.inputWrapper}>
                <LinearGradient colors={['#FF6200', '#4800AC']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.gradientBorder}>
                  <View style={styles.inputContainer}>
                ...
                {errors.surname && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.surname}</Text>}
              ...
              <View style={styles.inputWrapper}>
                ...
                {errors.email && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.email}</Text>}
              </View>
              ...
              <View style={styles.inputWrapper}>
                ...
                <LinearGradient colors={['#FF6200', '#4800AC']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.gradientBorder}>
                  <DropDownPicker open={open} value={gender} items={items} setOpen={setOpen} setValue={setgender} setItems={setItems} placeholder="Gender (optional)" placeholderStyle={{ color: '#CBC0C099', fontSize: wp(4) }}
                    style={styles.dropDown} dropDownContainerStyle={{ ...styles.dropDownContainer, zIndex: open ? 2000 : 0 }}
                    arrowIconStyle={styles.arrowIcon} textStyle={styles.textStyle} tickIconStyle={styles.tickIcon} listItemLabelStyle={{ color: '#CBC0C099', fontSize: wp(4) }} onBlur={() => handleBlur('gender')} onChangeValue={(value) => handleInputChange('gender', value)}
                  />
                </LinearGradient>
                {/* {errors.gender && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.gender}</Text>} */}
                {/* <Text style={styles.genderTextRight}>
                  Selecting gender is optional
                </Text> */}
              </View>
              ...
              <View style={styles.inputWrapper}>
                <LinearGradient colors={['#FF6200', '#4800AC']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.gradientBorder}>
                  <View style={styles.innerContainer}>
                    ...
                    <TextInput
                      style={[styles.input]} value={number}
                      onChangeText={(text) => {
                        const numericText = text.replace(/[^0-9]/g, '');
                        const formatted = formatRomanianPhoneNumber(numericText);
                      ...
                      placeholderTextColor="#CBC0C099"
                      maxLength={callingCode === '+40' ? 10 : 13}
                ...
                {errors.number && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.number}</Text>}
              </View>
              ...
              <View style={styles.inputWrapper}>
                ...
                {errors.password && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.password}</Text>}
              </View>
              ...
              <View style={styles.inputWrapper}>
                ...
                {errors.conpassword && <Text style={isTablet ? styles.tableterrorTextRight : styles.errorTextRight}>{errors.conpassword}</Text>}
              </View>
      ...
      {!isKeyboardVisible && (
        <View style={isTablet ? styles.tabletfixedButtonContainer : styles.fixedButtonContainer}>
          <Text style={styles.credentialerrorText}>{messageType}</Text>
          <TouchableOpacity activeOpacity={0.8} onPress={handleverfication}>
            <LinearGradient
            ...
            >
              <Text style={isTablet ? styles.tabletsubmitbutton : styles.submitbutton}>Register</Text>
            </LinearGradient>
          </TouchableOpacity>
