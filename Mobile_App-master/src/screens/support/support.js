  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          >
            {/* <Icon name="chatbubble-outline" size={24} color="white" style={styles.supportIcon} /> */}
                    ...
                    <View style={isTablet?styles.tabletsupportIcon:styles.supportIcon}>
                    <Supporticon/>
                    </View>
   
           
            <Text style={isTablet?styles.tabletheaderText:styles.headerText}>Support</Text>
          </LinearGradient>
        </View>
      </LinearGradient>
      ...
      {/* <LinearGradient colors={['#FF6200', '#1F00A7']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.helpTopLine} /> */}
          ...
          <Text style={isTablet?styles.tabletoptiontext:styles.optionText}>Help Center</Text>
      ...
      <View style={styles.optionContain}>
        ...
        <Text style={isTablet?styles.tabletoptiontext:styles.optionText}>Chat with Us</Text>
      </View>
