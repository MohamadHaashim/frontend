              ...
              >
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity style={styles.noButton} onPress={hideDeleteModal}>
                    <Text style={isTablet ? styles.tabletnoButtonText : styles.noButtonText}>No</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.yesButton} onPress={handleDeleteAccount}>
                    <Text style={isTablet ? styles.tabletyesButtonText : styles.yesButtonText}>Yes</Text>
                  </TouchableOpacity>
                </View>
              </LinearGradient>
            </View>
        ...
        <View key={refreshKey} style={styles.bottomSheetContainer}>
          ...
          <View style={styles.accountSheetContainer}>
            ...
            <TouchableOpacity onPress={() => accountSheetRef.current.close()}>
              <Text style={isTablet ? styles.tabletbottomSheetCloseaccount : styles.bottomSheetCloseaccount}>Back</Text>
            </TouchableOpacity>
            <LinearGradient
              colors={['#FF6200', '#4800AC']}
              start={{ x: 0, y: 0 }}
              ...
              style={styles.separatorbottom}
            />
            <View style={isTablet ? styles.tabletfooterAccountContainer : styles.footerAccountContainer}>
              <Image source={klassride} style={styles.footerLogo} />
            </View>
          </View>
        </View>
