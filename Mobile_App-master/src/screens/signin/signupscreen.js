...
export default function Signup() {
  ...
  //     webClientId: "490509769992-l9e5g5as1icefnrpbqptusmis3mpia1s.apps.googleusercontent.com", // Replace with your Web client ID
  //   });
  // }, []);
  ...
  //     console.log("calling the fire base ")
  //     const signInResult = await GoogleSignin.signIn();
  //     console.log(signInResult,"Loading the AUth ")
  ...
  try {
    ...
    // Always sign out first to force popup
  ...
  try {
    ...
    if (response.ok) {
      ...
      //   await AsyncStorage.setItem("phoneNumber", fullnumber || "");
      // }
      setNumber("");
      setPhoneError("");
      navigation.navigate("numberverify", { phonenumber: fullnumber });

    } else {
      if (responseData?.messages?.length) {
        setPhoneError(responseData.messages[0]);
      } else {
  ...
  return (
    <SafeAreaView style={[flex = 1, isLandscape ? styles.landscape : styles.portrait]}>
      ...
      > */}
      <ScrollView keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: wp(1) }}>
        <View style={styles.container}>
          <View style={styles.content}>
            <ImageBackground source={Blue} style={styles.blueimage}>
              ...
              <Text style={isTablet ? styles.tablettext1 : styles.text1}>Find the best ride at the best price,</Text>
              <Text style={isTablet ? styles.tablettext1 : styles.text1}>all in one place</Text>
            </ImageBackground>
          </View>
          ...
          <View style={[styles.overlay, { backgroundColor: isInputFocused ? 'transparent' : '#000000' }]}>
            <View>
              ...
              >
                <View style={styles.innerContainer}>
                  ...
                  <TextInput
                    style={isTablet ? styles.tablenumberinput : styles.numberinput}
                    value={number}
            ...
            <Text style={isTablet ? styles.tabletlogin : styles.login}>or login with</Text>
            ...
            <View style={styles.EmailinputContainer}>
              ...
              >
                <View style={styles.innerContainer}>
                  <TextInput
                    style={isTablet ? styles.tabletinputEmail : styles.inputEmail}
                    value={email}
            ...
            <View style={{ borderRadius: 10, overflow: "hidden", marginTop: wp(2) }}>
              <LinearGradient
                ...
                style={styles.gradientBorder}
              >
                <View style={isTablet ? styles.tabletpasswordContainer : styles.passwordContainer}>
                  <TextInput
                    style={isTablet ? styles.tabletinputPassword : styles.inputPassword}
                    value={Password}
            ...
            <View style={[styles.buttonspace1, { marginTop: error ? 0 : hp(2) }]}>
              ...
              >
                <TouchableOpacity activeOpacity={0.8} style={styles.button} onPress={handleSubmit}>
                  <Text style={isTablet ? styles.submitbuttonlogin : styles.submitbuttonlogin}>Login</Text>
                </TouchableOpacity>
              </LinearGradient>
            </View>
              ...
              <View style={styles.buttonspace}>
                <TouchableOpacity activeOpacity={0.8} onPress={handleRegister}>
                  <LinearGradient
                    ...
                    style={styles.gradientBorderbutton}
                  >
                    <Text style={isTablet ? styles.tabletContainer : styles.submitbutton}>Register</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            </View>
            ...
            {/* <View style={styles.lap}>
              <Text style={[isTablet ? styles.tabletlog : styles.log, { fontFamily: fonts.montseratSemiBold }]}>Sign up with</Text>
