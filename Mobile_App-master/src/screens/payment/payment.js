...
const Payment = ({ setLoading, startSpin, activeSheet, shouldFetchCards, refresh }) => {
  ...
  const handleAddcard = async () => {
    ...
    try {
      ...
      console.log(phoneNumber,"phoneNumber-addcard")
      console.log(email,"phoneNumber-addcard")
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        <View style={styles.header}>
          <LinearGradient
            ...
            <View style={styles.headerdata}>
              <Text style={isTablet ? styles.tabletheaderText : styles.headerText}>Payment Methods</Text>
            </View>
          </LinearGradient>
        </View>
      </LinearGradient>
      ...
      <LinearGradient
        ...
        style={isTablet ? styles.tabletcreditBottomLine : styles.creditBottomLine}
      />
