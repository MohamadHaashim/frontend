...
const BASE_URL = "https://api.quantumpeak.tech/api/v1/";
...
export const ENDPOINTS = {
  ...
  Firebase :`${BASE_URL}fcm/token`,
  whatsappValidation:`${BASE_URL}phone-validation`,
  phoneValidationSignIn :`${BASE_URL}phone-validation-sign-in`,
